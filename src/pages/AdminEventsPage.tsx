        ...
        <div className="space-y-6">
          <div className="glass-strong rounded-2xl p-6 racing-border">
            <div className="flex flex-wrap justify-between gap-4">
              ...
              <Link to="/admin/events/new" className="inline-flex items-center gap-2 rounded-xl bg-gradient-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20 hover:scale-105 transition-transform">
              ...
              <div key={event.id} className="glass-strong rounded-2xl p-5 racing-border group hover:bg-card/20 transition-colors">
                <div className="flex flex-wrap justify-between gap-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <a href={`/admin/events/${event.id}/registrations`} className="rounded-lg border border-border px-3 py-2 text-sm hover:bg-card transition-colors">Registrations</a>                    <button onClick={() => exportCsv(event)} className="inline-flex items-center gap-1 rounded-lg border border-border px-3 py-2 text-sm hover:bg-card transition-colors"><Download className="h-3.5 w-3.5" /> CSV</button>
